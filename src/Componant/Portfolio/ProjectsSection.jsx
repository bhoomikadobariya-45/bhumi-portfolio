          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute top-6 left-6 z-20">
                <span className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md text-gray-900 dark:text-white font-black px-4 py-2 rounded-2xl shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
                  {project.id}
                </span>
              </div>

              <div className="absolute inset-0 bg-linear-to-t from-gray-900/60 to-transparent group-hover:opacity-0 transition-opacity duration-500" />
              ...
              <div className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-700 ease-[0.22,1,0.36,1] z-20">
                <div className="m-4 p-8 bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl rounded-[2.2rem] border border-white dark:border-slate-700/50 shadow-2xl relative overflow-hidden">
                  <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-blue-500 to-indigo-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-1000 delay-300" />
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-10 h-10 flex items-center justify-center bg-gray-900 dark:bg-slate-700 text-white rounded-full hover:bg-blue-600 transition-colors"
                    >
                      <i
                        className={
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((t, i) => (
                      <span
                        key={i}
                        className="text-[10px] font-black text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800/50 px-3 py-1.5 rounded-xl uppercase tracking-widest border border-slate-200/50 dark:border-slate-700/50"
                      >
                        {t}
                      </span>
                    ))}
